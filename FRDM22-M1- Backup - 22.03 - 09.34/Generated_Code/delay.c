...
** ===================================================================
*/
__attribute__((naked, no_instrument_function)) void delay_Wait10Cycles(void)
{
...
** ===================================================================
*/
__attribute__((naked, no_instrument_function)) void delay_Wait100Cycles(void)
{
...
void delay_Waitms(uint16_t ms)
{
  ...
  msCycles = delay_NofCyclesMs(1, delay_INSTR_CLOCK_HZ);
  while(ms>0) {
    delay_WaitLongCycles(msCycles);
    ms--;
  }
  /*lint -restore */
}
